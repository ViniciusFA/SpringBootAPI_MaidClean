...
public class AvaliacoesController {
	...
	/*	/**
			 ...
			 * @return
			 *//*
				 * @RequestMapping(value = "/avaliacoes/{id_usuario}", method =
				 * RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
				 * public @ResponseBody Avaliacoes getRatingUser(@PathVariable("id_usuario") int
				 * id_usuario) {
				 * 
				 * avaliacoes = avaliacoesRepository.getRatingUser(id_usuario);
				 * 
				 * if (avaliacoes != null) { return avaliacoes; } else { return new
				 * Avaliacoes(); } }
				 */
