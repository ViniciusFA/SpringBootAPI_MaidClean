...
public class FuncionarioController {
	 ...
	 * @return
	 *//*
		 * @RequestMapping(value="/funcionario/{funcionarioFiltro}",method =
		 * RequestMethod.GET, produces=MediaType.APPLICATION_JSON_UTF8_VALUE)
		 * public @ResponseBody Funcionario
		 * buscarFiltro(@PathVariable("funcionarioFiltro") Funcionario
		 * funcionarioFiltro){
		 * 
		 * 
		 * 
		 * return this.funcionarioRepository.findByFuncionario(funcionarioFiltro);
		 * 
		 * }
		 */
